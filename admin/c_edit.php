...
if(isset($_GET['u_submit'])) {    
    ...
    $edit_sql = "UPDATE category SET Name='$cname', Icon='$cicon' WHERE ID=$cid";
...
if(isset($_GET['ID'])) {
    ...
    $s_sql = "SELECT * FROM category WHERE ID = $e_id";
                ...
                <div class="container-fluid px-4">
                    ...
                    <div class="card mb-4">
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                <label for="c_name" class="form-label">Category Icon</label>
                                <input value="<?php echo $final['Icon'];?>" type="text" class="form-control c_name" id="c_name" name="c_icon" required>
                            </div>
                            <div>
