...
if(isset($_GET['c_submit'])) {
    ...
    if( $conn->query($insert_sql)) {
        $result = "<h3 class='text-success'>Successful</h3>";
    } else {
        die ($conn->error);
    }
}
                    ...
                    <div class="card mb-4">
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control c_name" id="c_name" name="c_icon" required>
                            </div>
                            <div>
                                <button type="submit" class="btn btn-success mb-4" name="c_submit">Submit</button>
